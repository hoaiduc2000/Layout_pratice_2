...
public class LetterBar extends View {
    ...
    public static final int SECTION_SIZE = strLetterBars.length();
    ...
    static {
        ...
        for (int i = 0; i < SECTION_SIZE; i++) {
            ...
            mSections.add(String.valueOf((char) strLetterBars.charAt(i)));
        //    Log.d("AAA", " " + (char) strLetterBars.charAt(i) + " " + strLetterBars.codePointAt(i));
        }
        //   mSections.add("#");
